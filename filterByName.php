...
<body>
<?php 
if (isset($_SESSION['filterByName'])){
	if (empty($filterByName))	$filterByName = $_SESSION["filterByName"];?>
	    ...
	    <td  class="libList">
		    <form method='post'>
				<?php 
					...
					$q="select * from libraries where Name like '%".$filterByName."%' limit $offset, 5;";
					...
					echo '<div><h4 class="libTitle"><b>Αποτελέσματα αναζήτησης ("'.$filterByName.'")</b></h4>';
				    if($num > 0){
